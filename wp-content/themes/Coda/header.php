...
<div id="global-cd">
<div class="global-links"><a href="<?php echo site_url('/membership-login/'); ?>">Sign In</a> &nbsp;&nbsp;|  &nbsp;&nbsp;<a href="<?php echo site_url('/members/'); ?>">Join CODA</a>&nbsp;&nbsp; |&nbsp;&nbsp;  <a href="<?php echo site_url('/dealer-map/'); ?>">Dealer Locator</a>&nbsp;&nbsp; | &nbsp;&nbsp; <a href="<?php echo site_url('//coda-news/'); ?>">Subscribe to our Newsletter</a></div>
...
<a href="https://twitter.com/Coda2015Coda" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/social-002.gif" alt="social" width="39" height="39" border="0" /></a>
...
<ul>
<?php $the_query = new WP_Query( 'cat=39' ); ?>
