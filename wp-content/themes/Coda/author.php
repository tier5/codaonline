...
<div id="content" class="grid_9 <?php echo of_get_option('blog_sidebar_pos') ?>">
  ...
  <div class="author-info">
    <h2><?php _e('About:', 'theme1669'); ?> <?php echo $curauth->display_name; ?></h2>
    <p class="avatar">
  ...
  <div id="recent-author-posts">
    <h2><?php _e('Recent Posts by', 'theme1669'); ?> <?php echo $curauth->display_name; ?></h2>
		...
		if (have_posts()) : while (have_posts()) : the_post(); 
		 ...
		 <div class="no-results">
			<?php echo '<p><strong>' . __('No post yet.', 'theme1669') . '</strong></p>'; ?>
		</div><!--no-results-->
  ...
  <div id="recent-author-comments">
    <h2><?php _e('Recent Comments by', 'theme1669'); ?> <?php echo $curauth->display_name; ?></h2>
      <?php
      ...
      <ul>
        ...
        endforeach; else: ?>
                  <p>
                    <?php _e('No comments by', 'theme1669'); ?> <?php echo $curauth->display_name; ?> <?php _e('yet.', 'theme1669'); ?>
                  </p>
        <?php endif; ?>
            </ul>
