...
add_filter( 'wp_mail', 'wp_mail_filter_out_ampersands' );

function wp_mail_filter_out_ampersands( $args ) {

	$new_wp_mail = array(
		'to'          => $args['to'],
		'subject'     => $args['subject'],
		'message'     => html_entity_decode($args['message']),
...
//
//    wp_enqueue_style( 'fancybox', get_template_directory_uri() . '/css/jquery.fancybox.css', false, '2.1.5', 'all' );
