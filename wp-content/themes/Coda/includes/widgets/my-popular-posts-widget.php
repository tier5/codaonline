                    ...
                    if($posts){
                      foreach($posts as $post){
                        ...
                        <li>
                          ...
                          <?php } ?>
                         <div class="extra-wrap"> <h4><a href="<?php echo $guid; ?>" title="<?php echo $post_title; ?>"><?php echo my_string_limit_char($post_title,20);?>.</a></h4>
                          <?php if ($excerpt!="") { ?>
					 	<div class="excerpt"><?php echo my_string_limit_char($excerpt,50);?>.</div>
					 <?php } else { ?>	
					 	<div class="excerpt"><?php echo my_string_limit_char($content,50);?>.</div>
					 <?php } ?>
                          <a href="<?php echo $guid; ?>" class="button"><?php _e('Read more','theme1669');?></a></div>
                        </li>
                    <?php
                        }
                    }
