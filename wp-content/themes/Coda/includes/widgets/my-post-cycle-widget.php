...
class MY_CycleWidget extends WP_Widget {
    ...
    function widget($args, $instance) {		
        ...
        ?>
              ...
              <div id="testi-controls">
                <a href="#"><span id="prev-testi"><?php _e('Prev', 'theme1669'); ?></span></a> 
                <a href="#"><span id="next-testi"><?php _e('Next', 'theme1669'); ?></span></a>
                <ul id="nav-testi"></ul>
              </div>
							<!-- end of testimonials -->
                ...
                <div class="folio_item">
									...
									<?php if(has_post_thumbnail()) { ?>
										...
										$image = aq_resize( $img_url, 218, 150, true ); //resize & crop img
										?>
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Type of posts:', 'theme1669'); ?><br />
