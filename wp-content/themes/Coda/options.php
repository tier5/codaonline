...
function optionsframework_options() {
	...
	// Slider sticky
	$sl_sticky_array = array("true" => "Yes","false" => "No");
    ...
    $options[] = array( "name" => "Sticky",
                        "desc" => "One kwick will always be expanded.",
                        "id" => "sl_sticky",
                        "std" => "true",
                        "type" => "radio",
                        "options" => $sl_sticky_array);
 
    $options[] = array( "name" => "Default kwick",
                        "desc" => "The initially expanded kwick (if and only if sticky is true).",
                        "id" => "sl_default",
                        "std" => "1",
                        "class" => "mini",
                        "type" => "text");
 
    $options[] = array( "name" => "Duration",
